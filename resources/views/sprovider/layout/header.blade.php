                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="{{route('profiles.index')}}"><i class="fa fa- user"></i>My Profile</a>

                                <a class="nav-link" href="{{route('sprovider.changepassword')}}"><i class="fa fa -cog"></i>Change Password</a>
